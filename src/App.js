...
function getEngines(){
  fetch("http://localhost:3020/models")
  .then(res => res.json())
    ...
    <div className="App">
      ...
      <section className="chatbox">
        ...
        <div className="chat-input-holder">
          <form id="input-prompt" onSubmit={handleSubmit}>
          <input rows="1" value={input} onChange={(e)=> setInput(e.target.value) }
           className="chat-input-txtarea" placeholder="Type your meassge here">
